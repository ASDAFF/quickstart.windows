...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
	function InitStep()
	{
		...
		$siteLogo = $this->GetFileContentImgSrc(WIZARD_SITE_PATH."include/company_name.php", "/bitrix/wizards/quickstart/windows/site/templates/windows/themes/".$themeID."/lang/".LANGUAGE_ID."/logo.png");
		if (!file_exists(WIZARD_SITE_PATH."include/logo.png"))
			$siteLogo = "/bitrix/wizards/quickstart/windows/site/templates/windows/themes/".$themeID."/lang/".LANGUAGE_ID."/logo.png";
